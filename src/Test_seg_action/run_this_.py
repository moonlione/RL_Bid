from src.Test_seg_action.env import AD_env
from src.Test_seg_action.RL_brain import PolicyGradient
from src.Test_seg_action.RL_brain import store_para
    ...
    for episode in range(config['train_episodes']):
        ...
        for i in range(len(train_data)):
            ...
            ctr_action_records.append([current_data_clk, current_data_ctr, action,
                                           auc_data[config['data_marketprice_index']], bid])
